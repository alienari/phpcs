 ...
 */
class Collabim_Sniffs_WhiteSpace_NewlinesBetweenClassPartsSniff
	extends Collabim_Sniffs_WhiteSpace_AbstractConsecutiveSniffHelper
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
		...
		if ($class) {
			...
			while (TRUE) {
				...
				if ($semicolon && !$this->isNextLineEmpty($phpcsFile, $semicolon)) {
					$phpcsFile->addError(
						'Line after member variable declaration must be empty.',
						$semicolon
					);
				}
