...
/**
 * Moved to Collabim because of a bug (tabs before +-/* are handled as errors)
 */
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Collabim_Sniffs_WhiteSpace_OperatorSpacingSniff implements PHP_CodeSniffer_Sniff
{
